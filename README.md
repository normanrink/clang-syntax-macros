...
further information please refer to
  ...
  http://llvm.org/docs/GettingStarted.html  (for LLVM)
  http://clang.llvm.org/get_started.html    (for Clang)
 
Since you are reading this, you are on the 'syntax-macros' branch in the
present Clang repository, obtained from
...
working title used instead of syntax macros.)  Alternatively, you can use 'lit'
...
improvement should be submitted to
